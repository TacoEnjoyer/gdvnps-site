...
import GDVNPS_Icon from '../assets/gdps_icon.jpg'
...
<template>
  <header
    class="fixed z-50 w-full bg-black/30 shadow backdrop-blur-xl transition-all"
  >
    <nav class="mx-auto flex h-20 w-full max-w-7xl items-center px-4 md:px-8">
