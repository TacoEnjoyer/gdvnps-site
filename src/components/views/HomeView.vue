    ...
    <section class="relative">
      ...
      >
        <div class="flex flex-col items-center">
          <h1
            class="mb-4 text-balance bg-gradient-to-br from-yellow-500 to-red-600 bg-clip-text text-center font-bevnpro text-3xl/[1.1] font-bold text-transparent sm:max-w-[24ch] md:text-4xl/[1.1] xl:text-5xl/[1.1]"
          >
